    ...
    <section className="text-gray-600 body-font overflow-hidden">
      <div className="container px-5 py-24 mx-auto">
        <div className="lg:w-4/5 mx-auto flex flex-wrap">
          <Image width={350} height={350} alt="ecommerce" className="object-cover object-center rounded" src="/assets/Printer-store.c652a816.jpg" />
          <div className="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
            <h2 className="text-sm title-font text-gray-600 tracking-widest">SK Computer</h2>
            <h1 className="text-gray-900 text-3xl title-font font-medium mb-1">Printer Services</h1>
            ...
            <div className="flex flex-wrap">
              <span className="title-font font-medium text-2xl text-gray-900">₹1.00</span>
              {/*product details */}
              ...
              <button onClick={() => addToCart(slug, 1, 1, 'Printer service', 'no', 'black')} className="flex ml-auto text-white bg-orange-600 border-0 py-2 px-6 focus:outline-none hover:bg-orange-700 rounded">Add to Cart</button>
